// OA Locations v1.0 — locations.js
// Single source of truth for all 36 Nigerian states and their LGAs.
//
// Add this ONE script tag to each HTML page, before your other scripts:
//   <script src="locations.js"></script>
//
// The three JS files each use their own variable name — no code changes needed:
//   consumer.js    — uses  statesAndLGAs
//   business.js    — uses  bizLocationData
//   distributor.js — uses  nigerianData
// All three are aliases of the same OA_LOCATIONS object defined here.
...
// ── Aliases ──────────────────────────────────────────────────────────────────
// Each page JS file already references these variable names.
// Defining them here means zero changes needed inside consumer.js,
// business.js or distributor.js — they just work.
var statesAndLGAs   = OA_LOCATIONS;
var bizLocationData = OA_LOCATIONS;
var nigerianData    = OA_LOCATIONS;
